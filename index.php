    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                            ...
                            <li><a class="dropdown-item" href="">Servicio al cliente</a></li>
                            <li><div class="dropdown-divider"></div></li>
                ...
                <span class="nav-item">
                    <a class="btn-solid-sm" href="#contacto">Contacto</a>
                </span>
            </div> 
        </div>
    </nav> <!--Fin de Nav -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p class="p-large"> Da click aquí para descargar la aplicación de nuestro banco y comienza a usarlo</p>
                        <a class="btn-solid-lg" href="">Descargar</a>
                    </div> 
                </div>
            </div> 
        </div> 
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Tu opinión es muy importante para nosotros y queremos contar con la atención necesaria para tus problemas y sugerencias.</p>
